...
class Consistency_Difference_Aggregation(nn.Module):

    def __init__(self, icha=32):
        super(Consistency_Difference_Aggregation, self).__init__()
...
if __name__ == '__main__':
    ...
    cda = Consistency_Difference_Aggregation()

    fuse_ct_mri_fea, fuse_ct_mri_l = cda(img_mrict,img_ct)
    fuse_vis_ir_fea, fuse_vis_ir_l = cda(img_vis,img_ir)
